package com.ncertguruji.loadpdftest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String FILENAME = "Chapter4.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageIndex = 0;
         ...
         imageViewPdf = this.findViewById(R.id.pdf_image);
         prePageButton = this.findViewById(R.id.button_pre_doc);
         nextPageButton = this.findViewById(R.id.button_next_doc);

         prePageButton.setOnClickListener(view -> {
             onPreviousDocClick();
         });
